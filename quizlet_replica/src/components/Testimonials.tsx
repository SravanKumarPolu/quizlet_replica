    ...
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-24">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div>
            <img src="https://images.prismic.io/quizlet-web/ZuNicbVsGrYSvUQK_EN-GB3Learn.png?auto=format,compress" alt="Prepare for tests" className="w-full h-auto object-contain rounded-xl" />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 bg-[#e5e8fd] p-8 rounded-xl">
          <div>
            ...
            <p className="text-[16px] text-gray-700 leading-relaxed mb-6">
              Help every student learn anything with confidence. With free flashcard sets, study modes and in-class games like Quizlet Live, you can create a more engaged classroom instantly.
            </p>
          ...
          <div>
            <img src="https://images.prismic.io/quizlet-web/ZpFqjB5LeNNTxHvk_teacher-image-LOH.png?auto=format,compress" alt="Empower your students" className="w-full h-auto object-contain rounded-xl" />
          </div>
        </div>
      </div>
    </section>
